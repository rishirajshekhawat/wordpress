...
function get_lat_long($address){
    ...
    $region = '';
    $json = file_get_contents("https://maps.google.com/maps/api/geocode/json?address=$address&sensor=false&region=Rwanda&key=AIzaSyCGGYGuei_qq988y7TS4NXPbyr-aiH2Fnk");
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCGGYGuei_qq988y7TS4NXPbyr-aiH2Fnk&libraries=places&callback=initAutocomplete"></script>
