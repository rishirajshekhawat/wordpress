    ...
    <div class="dokan-dashboard-wrap">
        ...
        <div class="dokan-dashboard-content dokan-orders-content">
            ...
            <?php
                ...
                $cus_first_name = get_user_meta($request['customer']['id'],'first_name',true);
                $cus_last_name = get_user_meta($request['customer']['id'],'last_name',true);
                                    ...
                                    <table class="dokan-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $cus_first_name.' '.$cus_last_name; ?></td>
                                            </tr>
