...
?>
<section class="woocommerce-order-details fgfg hideextradriver">
    ...
    <div class="right_btns">
        ...
        <?php if ($order->get_status() == 'processing' ) { 
           ...
           <?php $ghj = $order->get_cancel_order_url( wc_get_page_permalink( 'myaccount' ) ); ?>
           
         <a href="<?php echo $ghj; ?>" class="woocommerce-button button cancel">Cancel Order</a>
         <?php  
