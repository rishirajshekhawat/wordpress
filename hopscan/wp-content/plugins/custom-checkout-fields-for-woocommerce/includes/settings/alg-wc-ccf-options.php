...
if ( ! function_exists( 'alg_get_wc_ccf_options' ) ) {
	 ...
	 * @todo    [next] Visibility Options - by value of another field?
	 * @todo    [later] Select2: Custom text: better descriptions
	 * @todo    [later] (desc) `priority` - better description (i.e. list current (core) fields priorities)
	...
	function alg_get_wc_ccf_options() {
		...
		$section_message    = __( 'Fill this section only if %s type is selected.', 'custom-checkout-fields-for-woocommerce' );
		...
		$products           = alg_wc_ccf_get_products();
		...
		$options = array(
			...
			array(
				'title'    => __( 'Customer meta fields', 'custom-checkout-fields-for-woocommerce' ),
			...
			array(
				...
				'desc_tip' => __( 'If set to zero - field will be added to the end of the section.', 'custom-checkout-fields-for-woocommerce' ),
				'id'       => 'priority',
				'default'  => 0,
				'type'     => 'number',
			),
			...
			array(
				'title'    => __( 'Select/Radio Type Options', 'custom-checkout-fields-for-woocommerce' ),
				'desc'     => sprintf( $section_message, '<strong>' . __( 'select/radio', 'custom-checkout-fields-for-woocommerce' ) . '</strong>' ),
				'type'     => 'title',
			...
			array(
				'title'    => __( 'Select: use "Select2"', 'custom-checkout-fields-for-woocommerce' ),
				'desc'     => __( 'Use', 'custom-checkout-fields-for-woocommerce' ),
