...
<div id="titlebar">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <h2><?php esc_html_e('Expired Listings','olomo'); ?></h2>
...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="dashboard-list-box margin-top-0">
            ...
            <h4><?php esc_html_e('Expired Listings','olomo'); ?></h4>
                                                                ...
                                                                if(!empty($category_image)){ ?>
                                                                    ...
                                                                    <li class="list_cate_icon">
                                                                        ...
                                                                        <a href="<?php echo get_term_link($cat); ?>">
                                                                            ...
                                                                            <img src="<?php echo esc_url($category_image); ?>" alt="<?php echo esc_attr($cat->name); ?>">
				   ...
				   <?php 
                    ...
                    <div class="error-column box-shadownon">
                            ...
                            <h2><?php esc_html_e('You have no listing expired.','olomo'); ?></h2>
