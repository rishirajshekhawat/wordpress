...
class Refund extends DokanModel {
    ...
    protected function create() {
        ...
        $order->add_order_note( sprintf(
            __( 'Refund request for order#'.$this->get_order_id().' send to admin' )  ) );
    ...
    public function approve() {
        ...
        $order->add_order_note( sprintf(
            __( 'Refund request for order#'.$this->get_order_id().' approved by admin' )) );
    ...
    public function cancel() {
        ...
        $order->add_order_note( sprintf(
            __( 'Refund request for order#'.$this->get_order_id().' cancel by admin' )) );
