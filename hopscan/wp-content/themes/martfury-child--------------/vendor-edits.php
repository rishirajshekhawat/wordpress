...
function prefix_save_about_settings() {
	...
	$password = wp_generate_password(12, true);
       ...
       $user_id = wp_insert_user( $userdata );
		...
		$message .='<p>Your email is registered as HoPscan Driver. Your account details are shown below for your reference. Please login using username and password.</p>';
