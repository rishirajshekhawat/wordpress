...
jQuery(document).ready(function($){
    jQuery(".woocommerce-MyAccount-navigation-link--customer-logout a").attr("href", "http://hopscan-stg.com/wp-login.php?action=logout&redirect_to=http://hopscan-stg.com/my-account");
...
jQuery(document).ready(function(){
    // Change text of button element
    jQuery("form#kas_search").attr('action', 'http://hopscan-stg.com/vendors/');
});
</script>
<script>
/*
