...
<div class="dokan-form-group">
    ...
    <div class="dokan-w5 dokan-text-left dokan-address-fields">
      ...
      <?php if ( $seller_address_fields['street_1'] ) { ?>
                ...
                <input <?php echo esc_attr( $required_attr ); ?> <?php echo esc_attr( $disabled ) ?> id="dokan_address[street_1]" value="<?php echo esc_attr( $address_street1 ); ?>" name="dokan_address[street_1]" placeholder="<?php esc_attr_e( 'Street address' , 'dokan-lite' ) ?>" class="ghghgh dokan-form-control input-md" type="text" required>
      ...
      <?php if ( $seller_address_fields['country'] ) {
        ...
        <select name="dokan_address[state]" class="statefield_clean dokan-form-control <?php echo esc_attr( $address_state_class ) ?>" id="dokan_address_state" required>
