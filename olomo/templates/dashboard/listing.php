...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="dashboard-list-box margin-top-0">
            ...
            <h4><?php esc_html_e('Active Listings','olomo'); ?></h4>
                                ...
                                <div class="list-box-listing">
                                    ...
                                    <div class="list-box-listing-content">
                                        ...
                                        <div class="inner">
                                            ...
                                            <h3><a href="<?php echo get_the_permalink(); ?>"><?php the_title(); ?></a> <span class="green" data-toggle="tooltip" title="Total Views"><?php echo $recentviews; ?></span></h3>
                                                        ...
                                                        if(!empty($cats)){
                                                            ...
                                                            foreach ( $cats as $cat ) {
                                                                ...
                                                                if(!empty($category_image)){ ?>
                                                                    ...
                                                                    <li class="list_cate_icon"><a href="<?php echo get_term_link($cat); ?>"><img src="<?php echo esc_attr($category_image); ?>" alt="<?php echo esc_attr($cat->name); ?>"></a>
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <form method="post">
                                          ...
                                          <div class="modal-footer">
                                             ...
                                             <input type="submit" value="<?php esc_html_e('Yes', 'olomo'); ?>" class="btn">
				...
				wp_reset_postdata();
                        ...
                        <div class="error-column box-shadownon">
                            ...
                            <h2><?php esc_html_e('You have no listing.','olomo'); ?></h2>
