...
function send_otp_to_recipients($order_id) {
	...
	if($user_phone){
			...
			$args = array(
    			...
    			'message' => '[HoPscan]-You have received an order #'.$order_id.' from developerr tester| One Time Password: '.$otp.'|Seller: PIONEER SUPPLY / 5392 Contrecoeur, Montreal, Quebec, Canada.', 
     		); 
