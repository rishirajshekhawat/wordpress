...
class Admin {
	...
	public function add_listing_actions( $order ) {
		...
		foreach ($listing_actions as $action => $data) {
			...
			<a href="<?php echo $data['url']; ?>" class="button tips wpo_wcpdf <?php echo $data['exists'] == true ? "exists " . $action : $action; ?>" target="_blank" alt="<?php echo $data['alt']; ?>" data-tip="<?php echo $data['alt']; ?>" data-original-title="<?php echo $hv_txt;?>">
