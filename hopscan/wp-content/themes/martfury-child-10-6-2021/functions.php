    ...
    if ( ! class_exists( 'WC_Your_Shipping_Method' ) ) {
        ...
        class WC_flat_Shipping_Method extends WC_Shipping_Method {
            ...
            public function calculate_shipping( $package ) {
                ...
                if($store_named1 == $address_user && $address_user_country == $store_country1){
                // Register the rate
                $this->add_rate( $rate );
...
$args = array( 
	'number_to' => $phone12,
	'message' => '[HoPscan]-You have been assigned order #'.$order_id_id.' from by seller: '.$store_name.' / '.$address1.'| '.$address2.' Phone: '.$store_phone.'|', 
 ); 
