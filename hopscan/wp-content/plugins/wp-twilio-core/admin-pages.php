	...
	<form method="post" action="options.php">
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					<input size="50" type="text" name="<?php echo TWL_CORE_OPTION; ?>[service_id]" placeholder="<?php _e( 'Enter Notify Service ID', TWL_TD ); ?>" value="<?php echo htmlspecialchars( $options['service_id'] ); ?>" class="regular-text" />
					<br />
...
function twl_display_tab_notifications( $tab, $page_url ) {
	...
	<table class="form-table">
			<tr valign="top">
				...
				<td>
					<input size="50" type="text" name="<?php echo TWL_CORE_NOTIFICATION_OPTION; ?>[notification_number]" placeholder="<?php _e( 'Enter Notification Number', TWL_TD ); ?>" value="<?php echo htmlspecialchars( $options['notification_number'] ); ?>" class="regular-text" />
	...
	<h3><?php _e( 'New Post Published', TWL_TD ); ?></h3>
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<input type="checkbox" name="<?php echo TWL_CORE_NOTIFICATION_OPTION;?>[new_post_published_cb]" value="1" <?php checked( $options['new_post_published_cb'], 1, true ); ?> />
				</td>
			</tr>
			...
			<tr valign="top">
				...
				<td>
					<textarea name="<?php echo TWL_CORE_NOTIFICATION_OPTION;?>[new_post_published_message]" class="regular-text" style="display:block;"><?php echo $options['new_post_published_message']; ?></textarea>
		...
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><?php _e( 'Activate:', TWL_TD ); ?></th>
				<td>
					<input type="checkbox" name="<?php echo TWL_CORE_NOTIFICATION_OPTION;?>[new_user_registered_cb]" value="1" <?php checked( $options['new_user_registered_cb'], 1, true ); ?> />
				</td>
			</tr>
			...
			<tr valign="top">
				<th scope="row"><?php _e( 'Message:', TWL_TD ); ?></th>
				<td>
					<textarea name="<?php echo TWL_CORE_NOTIFICATION_OPTION;?>[new_user_registered_message]" class="regular-text" style="display:block;"><?php echo $options['new_user_registered_message']; ?></textarea>
					<p><?php _e( 'Enter the content of the sms message', TWL_TD ); ?></p>
		...
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><?php _e( 'Activate:', TWL_TD ); ?></th>
				<td>
					<input type="checkbox" name="<?php echo TWL_CORE_NOTIFICATION_OPTION;?>[new_comment_cb]" value="1" <?php checked( $options['new_comment_cb'], 1, true ); ?> />
				</td>
			</tr>
			...
			<tr valign="top">
				<th scope="row"><?php _e( 'Message:', TWL_TD ); ?></th>
				<td>
					<textarea name="<?php echo TWL_CORE_NOTIFICATION_OPTION;?>[new_comment_message]" class="regular-text" style="display:block;"><?php echo $options['new_comment_message']; ?></textarea>
					<p><?php _e( 'Enter the content of the sms message', TWL_TD ); ?></p>
		...
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><?php _e( 'Activate:', TWL_TD ); ?></th>
				<td>
					<input type="checkbox" name="<?php echo TWL_CORE_NOTIFICATION_OPTION;?>[new_login_cb]" value="1" <?php checked( $options['new_login_cb'], 1, true ); ?> />
				</td>
			</tr>
			...
			<tr valign="top">
				<th scope="row"><?php _e( 'Message:', TWL_TD ); ?></th>
				<td>
					<textarea name="<?php echo TWL_CORE_NOTIFICATION_OPTION;?>[new_login_message]" class="regular-text" style="display:block;"><?php echo $options['new_login_message']; ?></textarea>
					<p><?php _e( 'Enter the content of the sms message', TWL_TD ); ?></p>
