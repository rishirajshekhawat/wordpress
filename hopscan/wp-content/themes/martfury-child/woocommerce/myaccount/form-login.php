                ...
                <input type="hidden" id="selected_role" name="selected_role" value="customer" />
                 ...
                 <?php /*?> <p class="form-row form-group form-row-wide send_otp_msg_row">
                  ...
                  <p class="form-row form-group">
                   ...
                   <p class="register_phone woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    ...
                    <p><?php esc_html_e( 'We verify this number with an SMS to protect your account.', 'martfury' ); ?></p>
                   <p class="phone_otp woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    <input type="number" class="woocommerce-Input woocommerce-Input--phone-otp input-text" name="phone-otp" id="phone-otp" value=""/>
                    <input type="button" class="woocommerce-Button button" name="verify" id="verify_top" value="Verify Code" />
                    <input type="button" class="woocommerce-Button button" name="verify" id="ph_otp" value="Send Code" />
                    
                    </p>
                    <p class="verification_msg"><?php esc_html_e( 'Enter a verification code received on your mobile.', 'martfury' ); ?></p>
