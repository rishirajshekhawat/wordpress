...
use Instance;
    ...
    "WOOCOMMERCE_PASSWORD_RESET" =>      [
      ...
      "VERIFICATION_VIA_LINK" =>      [
        ...
        'addonDescription'  => 'Allows users to be verified via accept/rejects links receieved on the email instead of OTPs.<br>Click on the button below for further details.',
        'addonPrice' => '$29*',
