...
<!-- /Inner-Banner -->
<div id="inner_pages" class="listing_banner">
	<div class="container">
        ...
        <div class="row">
            ...
            <?php if(!empty($olomo_options['single_sidebar_banner_link'])){ ?>
                	<a href="<?php echo esc_url($olomo_options['single_sidebar_banner_link']); ?>" target="_blank">
            <?php } ?>     
                    <img src="<?php echo esc_url($olomo_options['single_sidebar_banner']['url']); ?>" alt="image">
            <?php if(!empty($olomo_options['single_sidebar_banner_link'])){ ?> 
                    </a>
            <?php } ?>     
                </div>
                ...
                <div class="sidebar_widgets">
                	<div class="ads_col">
					  <?php if(!empty($olomo_options['single_sidebar_banner1_link'])){ ?>
                      <a href="<?php echo esc_url($olomo_options['single_sidebar_banner1_link']); ?>" target="_blank">
                      <?php } ?> 
                        <img src="<?php echo esc_url($olomo_options['single_sidebar_banner1']['url']); ?>" alt="image">
             <?php if(!empty($olomo_options['single_sidebar_banner1_link'])){ ?> 
                    </a>
            <?php } ?>   
                    </div>
                    <div class="ads_col">
                   <?php if(!empty($olomo_options['single_sidebar_banner2_link'])){ ?>
                      <a href="<?php echo esc_url($olomo_options['single_sidebar_banner2_link']); ?>" target="_blank">
                   <?php } ?> 
                        <img src="<?php echo esc_url($olomo_options['single_sidebar_banner2']['url']); ?>" alt="image">
                 <?php if(!empty($olomo_options['single_sidebar_banner2_link'])){ ?> 
                    </a>
                 <?php } ?>   
                    </div>
