<?php
/**
 * Blog List template for our theme
 *
 * @package WordPress
 * @subpackage olomo
 * @since olomo 1.5
    ...
    <div class="container">
        <div class="row">
                          ...
                          <article class="col-md-12 article_wrap">
							   <?php if(has_post_thumbnail()): ?>
                                    <div class="post-thumbnail">
                                    	<a href="<?php the_permalink(); ?>"> <?php the_post_thumbnail('olomo-blog-grid', array('class' => 'center-block img-responsive')); ?> </a>
                                    </div>
                               <?php endif; ?>
            ...
            <aside class="col-md-4">
                <?php get_template_part('sidebar', 'loop'); ?>    
            </aside>
        </div>
    </div>
</div>