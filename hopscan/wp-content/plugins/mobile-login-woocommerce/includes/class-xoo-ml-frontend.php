...
class Xoo_Ml_Phone_Frontend{
	...
	public function hooks(){
		...
		if( $this->settings['r-enable-phone'] === "yes" ){
			...
			add_action( 'woocommerce_register_form', array( $this, 'wc_register_phone_input' ) );
		//	add_action( 'dokan_reg_form_field', array( $this, 'wc_register_phone_input' ) );
		//	add_action( 'custom_phone_data', array( $this, 'wc_register_phone_input' ) );
