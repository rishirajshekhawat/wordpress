...
?>
<?php
    $gravatar_id    = ! empty( $profile_info['gravatar'] ) ? $profile_info['gravatar'] : '';
    $banner_id      = ! empty( $profile_info['banner'] ) ? $profile_info['banner'] : '';
	...
	$phone_cd       = isset( $profile_info['phone_cd'] ) ? $profile_info['phone_cd'] : '';
...
<?php do_action( 'dokan_settings_before_form', $current_user, $profile_info ); ?>
    <script>
      /*  $('.dokan-btn-theme').on('click',function(){
            var bannerfield = jQuery(".banner_field_require").val();
            if(bannerfield == '0')
            {
                alert("Please Add Banner To Save Information(Banner size is (1500x450) pixels)");
            }else{
    ...
    <form method="post" id="store-form"  action="" class="dokan-form-horizontal">
        ...
        <?php wp_nonce_field( 'dokan_store_settings_nonce' ); ?>
            ...
            <div class="dokan-banner">
                ...
                <div class="image-wrap<?php echo $banner_id ? '' : ' dokan-hide'; ?>">
                    ...
                    <input type="hidden" class="dokan-file-field banner_field_require" value="<?php echo $banner_id; ?>" name="dokan_banner" required>
        ...
        <div class="dokan-form-group">
            ...
            <div class="dokan-w5 dokan-gravatar">
                <div class="dokan-left gravatar-wrap<?php echo $gravatar_id ? '' : ' dokan-hide'; ?>">
                    ...
                    <input type="hidden" class="dokan-file-field" value="<?php echo esc_attr( $gravatar_id ); ?>" name="dokan_gravatar" required>
        ...
        <div class="dokan-form-group">
            ...
            <div class="dokan-w5 dokan-text-left">
               <!-- <input id="setting_phone_cd" value="<?php echo esc_attr( $phone_cd ); ?>" name="phone_cd" placeholder="<?php esc_attr_e( '+1', 'dokan-lite' ); ?>" class="dokan-form-control input-md" type="text" readonly="readonly">
                <style>
				#store-form input#setting_phone {
					width: 87%;
					float: left;
				}
				input#setting_phone_cd {
					pointer-events: none;
					width: 13%;
					float: left;
					background: #e8e8e8;
                ...
                <input id="setting_phone" value="<?php echo esc_attr( $phone ); ?>" name="setting_phone" placeholder="<?php esc_attr_e( '+23243...', 'dokan-lite' ); ?>" class="dokan-form-control input-md" type="text">
            </div>
        </div>
        ...
        <div class="dokan-form-group">
            ...
            <div class="dokan-w4 ajax_prev dokan-text-left" style="margin-left:24%;">
                <input type="button" id="update_submit_vendor" name="dokan_update_store_settings" class="dokan-btn dokan-btn-danger dokan-btn-theme update_store_btnm" value="<?php esc_attr_e( 'Update Settings', 'dokan-lite' ); ?>">
            </div>
        </div>
    </form>
