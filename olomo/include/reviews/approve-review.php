<?php
	if(!function_exists('olomo_ajax_approve_review_init')){
		function olomo_ajax_approve_review_init(){
	...
	add_action('init', 'olomo_ajax_approve_review_init');
	add_action('wp_ajax_olomo_review_status', 'olomo_review_status');
	add_action('wp_ajax_nopriv_olomo_review_status', 'olomo_review_status');
	if(!function_exists('olomo_review_status')){
		function olomo_review_status(){
