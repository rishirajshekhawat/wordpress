...
<div class="" style=" <?php //echo esc_attr( $role_style ); ?>">	
...
<p class="form-row form-group user-role">
	...
	<label class="radio woocommerce-form__label-for-checkbox">
		...
		<input type="hidden" name="role" class="woocommerce-form__input-checkbox" value="customer"<?php checked( $role, 'customer' ); ?>>
