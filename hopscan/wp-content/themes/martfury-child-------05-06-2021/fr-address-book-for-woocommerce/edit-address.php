...
<div class="fabfw-edit-address-container gfhgfhg">
    <form method="post" action="<?php echo get_site_url(); ?>/my-account/edit-address/">
        <div class="woocommerce-address-fields">
            ...
            <p>
                <button type="submit" class="button"><?php esc_html_e('Save recipient', 'fr-address-book-for-woocommerce') ?></button>
