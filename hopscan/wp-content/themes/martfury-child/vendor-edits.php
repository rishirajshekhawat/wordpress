...
function show_driver_details(){
	...
	if($user){		   
		$res .='<div class="modal-content dsd" style="display: inline-table;">
        ...
        <div class="dokan-w5">
            ...
            <?php 
				foreach($profile_info['categories'] as $terms){
					...
					?>
				 <option value="<?php echo $terms->name; ?>" <?php if($pm_cat == $terms->name){ echo 'selected';}else{echo '';}?>><?php echo $terms->name; ?></option>
               <?php }
				}
			?>
