<div id="dokan-seller-listing-wrap" class="grid-view test">
    <div class="seller-listing-content">
                ...
                foreach ( $sellers['users'] as $seller ) {
                        ...
                        <div class="store-wrapper">
                            <div class="store-header">
                                <div class="store-banner">
									...
									<a class="home_wrapper_link" href="<?php echo esc_url( $store_url ); ?>">
</a>
                                </div>
                            </div>
                                    ...
                                    <div class="store-data">
                                        ...
                                        <?php if ( ! dokan_is_vendor_info_hidden( 'address' ) && $store_address ): ?>
                                            <?php
												...
												$address_sep = substr($store_address, 0, strpos($store_address, ','));
                                            ?>
                                            <p class="store-address address-<?php echo $seller->ID; ?>"><?php echo wp_kses( $store_address, $allowed_tags ); ?></p>
                                        <?php endif ?>
					...
					<script>
						jQuery(document).ready(function(){
							var street_address1 = jQuery('.address-<?php echo $seller->ID; ?> .street_1').text();
							var streetaddress1= street_address1.substr(0, street_address1.indexOf(',')); 
							jQuery('.address-<?php echo $seller->ID; ?> .street_1').text(streetaddress1+ ',');
						});
					</script>
        ...
        <?php else:  ?>
            <p class="dokan-error"><?php esc_html_e( 'No vendor found, coming soon!', 'dokan-lite' ); ?></p>
